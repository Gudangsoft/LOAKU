...
@section('title', 'Backup Management - Admin Panel')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1">Backup Management</h1>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        @if(!$backup['is_directory'])
                                            <a href="{{ route('admin.backups.download', ['filename' => urlencode($backup['filename'])]) }}" 
...
function createBackup() {
    ...
    const url = currentBackupType === 'database' 
        ? '{{ route("admin.backups.create-database") }}'
        : '{{ route("admin.backups.create-files") }}';
