        ...
        <div class="col-lg-8">
            <div class="card shadow-lg">
                <div class="card-header bg-success text-white">
                    ...
                    <p class="mb-0 mt-2">Isi informasi lengkap penerbit/institusi yang akan ditambahkan</p>
                </div>
            ...
            <div class="card mt-4">
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mb-0">
                        ...
                        <li><i class="fas fa-check text-success me-2"></i>Logo akan digunakan dalam header PDF LOA</li>
