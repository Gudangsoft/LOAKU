                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-4">
                            <div id="qr-scanner" style="width: 100%; max-width: 400px; margin: 0 auto;">
                                <video id="preview"
                                    style="width: 100%; border-radius: 8px; border: 2px solid #dee2e6;"></video>
                            </div>
                            <div class="mt-3">
                        ...
                        <div class="border-top pt-4">
                            ...
                            <form action="{{ route('loa.check') }}" method="POST">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="loa_code"
                                        placeholder="Masukkan kode LOA (contoh: LOA20250801001)" required>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function startScanning() {
                if (cameras.length > 0) {
                    scanner.start(cameras[currentCamera]).then(() => {
