                    ...
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                   value="{{ old('name') }}" placeholder="mis. Basic, Professional, Enterprise" required>
                            @error('name') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="mb-0">
                            <label class="form-label fw-semibold">Deskripsi Singkat</label>
                            <textarea name="description" rows="2" class="form-control"
                                      placeholder="Cocok untuk publisher dengan kebutuhan...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" name="duration_months" class="form-control @error('duration_months') is-invalid @enderror"
                                           value="{{ old('duration_months', 12) }}" min="1" required>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_journals" class="form-control @error('max_journals') is-invalid @enderror"
                                       value="{{ old('max_journals') }}" min="1" id="maxJournals"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="max_loa_per_month" class="form-control @error('max_loa_per_month') is-invalid @enderror"
                                       value="{{ old('max_loa_per_month') }}" min="1" id="maxLoa"
                                       placeholder="Kosongkan = tidak terbatas">
                            ...
                            <div class="col-md-6 mb-3 d-flex align-items-end">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1"
                                           {{ old('is_active', '1') ? 'checked' : '' }} style="width:2.5em;height:1.25em;">
                ...
                <div class="card-body p-4">
                    <div id="previewCard" style="border:2px solid #4F46E5;border-radius:16px;overflow:hidden;">
                        <div style="background:linear-gradient(135deg,#4F46E5,#7C3AED);padding:20px 24px;color:white;">
                            <div style="font-size:1.2rem;font-weight:700;" id="prevName">Nama Paket</div>
                            <div style="font-size:2rem;font-weight:800;margin:8px 0;" id="prevPrice">Rp 0</div>
                            <div style="opacity:.8;font-size:.85rem;" id="prevDuration">per 12 bulan</div>
                        </div>
                        <div style="padding:20px 24px;">
                            <div class="text-muted small mb-3" id="prevDesc">Deskripsi paket...</div>
...
const iconMap = {
    'fas fa-file-csv':  '📊', 'fas fa-file-code': '📝', 'fas fa-globe': '🌐',
    'fas fa-headset':   '🎧', 'fas fa-chart-bar': '📈', 'fas fa-tag':   '🏷️',
    'fas fa-code':      '🔌',
};
