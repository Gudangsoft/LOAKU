            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body bg-gradient-primary text-white rounded">
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto">
                            <div class="text-end">
                                <div class="fs-6 opacity-75">{{ now()->format('l, d F Y') }}</div>
                                <div class="fs-5 fw-bold">{{ now()->format('H:i') }} WIB</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-transparent border-0 pb-0">
                    <h6 class="card-title mb-0">
                        <i class="fas fa-chart-pie me-2 text-primary"></i>Distribusi Status Permohonan
                    </h6>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fw-semibold">{{ $request->author }}</div>
