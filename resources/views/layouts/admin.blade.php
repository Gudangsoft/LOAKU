...
<body>
    ...
    <header class="admin-header">
        <div class="d-flex align-items-center">
            ...
            <a href="{{ route('admin.dashboard') }}" class="header-brand d-flex align-items-center">
                @if(site_logo())
                    <img src="{{ site_logo() }}" alt="{{ site_name() }}" style="height:32px;max-width:130px;object-fit:contain;margin-right:8px;">
                @else
